...
## incline
vt.& vi.
（使）倾斜，弄斜；（使）偏向，倾向于；（使）认为；点（头）（以示同意、打招呼等）
n.
斜坡；斜面；坡度；倾斜

## apparent
adj.
易看见的，可看见的；显然的，明明白白的；貌似的，表面的；

## headquarters
n.
（机构，企业等的）总部；总店；司令部；指挥部
## blast
n.
爆炸；一阵（疾风等）；（吹奏乐器、哨子、汽车喇叭等突然发出的）响声；
vt.
击毁，摧毁；尖响；裁判高声吹哨；枯萎：使枯萎
vi.
爆炸；吼叫；枯萎：枯萎；

## batch
n.
一批；一炉；（食物、药物等的）一批生产的量；
...
## Christian
adj.
基督教的;信奉基督教的;基督教徒的;有基督教徒品行的;慈善的;仁慈的;友爱的
n.
基督徒;基督教徒
...
## crude
adj.
粗糙的，粗杂的；粗鲁的；天然的，未加工的；简陋的
n.
原[生]材料，天然物质；原油；

## ensure
vt.
确保；担保获得[避免]；使（某人）获得；使安全
## negotiate
vi.
谈判，协商，交涉；
vt.
